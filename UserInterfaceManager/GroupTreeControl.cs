...
namespace UserInterfaceManager
{
    public partial class GroupTreeControl : UserControl
    {
        ...
        {
            _groupEditToolStrip.Enabled = _groupDeleteToolStrip.Enabled =
            _editGroupContextMenu.Enabled = _deleteGroupContextMenu.Enabled =
             _copyGroupContextMenu.Enabled = _pasteGroupContextMenu.Enabled =
             _groupTreeView.SelectedNode != null;
        }
        ...
        {
            Group selectedGroup = ContextMgr.SelectedGroup;
            DataObject groupObject = new DataObject("GroupObject", selectedGroup);
            Clipboard.SetDataObject(groupObject);
        }
